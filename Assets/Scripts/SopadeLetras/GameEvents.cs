...
public static class GameEvents
{
    ...
    public delegate void CorrectWord(string w, List<int> squareIndexes);
    public static event CorrectWord OnCorrectWord;
    public static void CorrectWordMethod(string w, List<int> squareIndexes)
    {
        if (OnCorrectWord != null)
        {
            OnCorrectWord(w, squareIndexes);
        }
    }
    //******************************************
